(function (root) {
    ...
    locale.pl_PL = {
        ...
        OPERATIONS_ONE_POINT_INVERSE_THRESHOLD: 'Odwrotne progowanie',
        OPERATIONS_ONE_POINT_THRESHOLD_RANGES: 'Progowanie przedziałami',
        OPERATIONS_ONE_POINT_THRESHOLD_WITH_GRAY_SCALES: 'Progowanie z zachowaniem przedziałów szarości',
